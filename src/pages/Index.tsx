        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: 'Gem', title: 'Щебень', desc: 'Фракции 5-10мм, 5-20мм, 20-40мм, 40-70мм, 25-60мм, 100-200мм, разногабаритный' },
              ...
              { icon: 'Layers', title: 'Смесь С-11', desc: 'Щебёночно-песчаная смесь' },
              { icon: 'Layers', title: 'Смесь С-5', desc: 'Щебёночно-песчаная смесь' },
              { icon: 'Layers', title: 'Смесь С-4', desc: 'Щебёночно-песчаная смесь' },
              { icon: 'Layers', title: 'Смесь С-4 (М800)', desc: 'Высокопрочная смесь' },
